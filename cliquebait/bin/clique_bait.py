...
def main(**arg): 
    ...
    plot_prefix = arg['plot'] if arg['plot'] else None
...
if __name__ == "__main__":
    ...
    parser.add_argument('--plot', '-p', nargs = "?", const = cliquebait.default_plot_prefix, type = str, default = None , help = f"draw and save plot with the value as prefix, default {cliquebait.default_plot_prefix}, if not indicated plots will not be drawn")
