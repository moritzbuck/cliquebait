...
if __name__ == "__main__":
    ...
    parser.add_argument('--strain_cutoff', '-s', nargs = 1, type=float, default = [cliquebait.default_strain_cutoff], help = "similarities above that threshold are ignored in the clustering (considered intra-species clusters, e.g. strain), default {cliqueblocks.default_strain_cutoff}")
